...
### Rolling Back / Traffic Switching

If you need to instantly switch back to a previous revision (or fast-forward), use the interactive layout script:

```bash
./switch-traffic.sh
```

It will prompt you to select the version you want to route 100% of live traffic to, completing the switch with zero downtime.
